...
![](/assets/image/코로나전과후.png){: width="80%" height="80%"}{: .align-center}
...
![](/assets/image/코로나전과후2.png){: width="80%" height="80%"}{: .align-center}
...
![](/assets/image/시계열데이터분석.png){: width="80%" height="80%"}{: .align-center}
