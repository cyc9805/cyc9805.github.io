...
<br> 하는 방법은 문단의 바로 다음줄에 {: .notice}만 붙여 주기만 하면 된다. 이때, notice 뒤에 minimal mistakes에서 지정한 notice의 종류 이름을 붙여줄 수도 있다.
...
---
<br>일단 이 정도 문법이면 블로그를 작성하는데 문제는 없을 것 같다. 만약 더 필요한 문법이 생기면 더 추가해서 적도록 하겠다.
