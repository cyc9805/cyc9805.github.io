...
![](/assets/image/dacon_commen22.png){: width="80%" height="80%"}{: .align-center}
...
![](/assets/image/dacon_comment23.png){: width="80%" height="80%"}{: .align-center}

2. xgboost 를 이용했을 때 public score 은 84.50 정도가 나왔다.

![](/assets/image/dacon_comment24.png){: width="80%" height="80%"}{: .align-center}

3. 선형회귀를 이용했을 때 public score 은 84.50 정도가 나왔다.

![](/assets/image/dacon_comment25.png){: width="80%" height="80%"}{: .align-center}

4. 신경망을 이용했을 때는 예상했듯이 처참한 점수인 405.90(...😮‍💨😮‍💨)가 나왔다.

![](/assets/image/dacon_comment26.png){: width="80%" height="80%"}{: .align-center}
